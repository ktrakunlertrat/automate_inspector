...
(async () => {
    ...
    try {
        ...
        // 8️⃣ คลิกเมนู
        await page.waitForSelector('//button[contains(., "5.1 การขับเคลื่อนงานของคณะกรรมการคุ้มครองเด็กจังหวัด")]');
        await page.click('//button[contains(., "5.1 การขับเคลื่อนงานของคณะกรรมการคุ้มครองเด็กจังหวัด")]');

        // 9️⃣ รอให้เมนูย่อยแสดง แล้วคลิก "บันทึกข้อมูลครั้งที่ 1"
        await page.waitForSelector('a[href="https://volunteer-smart-beta.nu.ac.th/beta-inspectorNew/index.php/Y2568Report0202Controller?time_count=1&order=5.1&title=การขับเคลื่อนงานของคณะกรรมการคุ้มครองเด็กจังหวัด "]'); // รอให้ลิงก์โหลด
        await page.click('a[href="https://volunteer-smart-beta.nu.ac.th/beta-inspectorNew/index.php/Y2568Report0202Controller?time_count=1&order=5.1&title=การขับเคลื่อนงานของคณะกรรมการคุ้มครองเด็กจังหวัด "]'); // คลิกลิงก์
        ...
        await page.fill('input[name="position_name_reporter"]', 'ผู้รายงาน5.1'); // ตำแหน่ง
