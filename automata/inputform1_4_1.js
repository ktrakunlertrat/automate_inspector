...
(async () => {
    ...
    try {
        ...
        // 8️⃣ คลิกเมนู
        await page.waitForSelector('//button[contains(., "1.4.1 นิคม NEXT")]');
        await page.click('//button[contains(., "1.4.1 นิคม NEXT")]');

        // 9️⃣ รอให้เมนูย่อยแสดง แล้วคลิก "บันทึกข้อมูลครั้งที่ 1"
        await page.waitForSelector('a[href="https://volunteer-smart-beta.nu.ac.th/beta-inspectorNew/index.php/Y2568Report05Controller?time_count=1&order=1.4.1&title=นิคม NEXT"]'); // รอให้ลิงก์โหลด
        await page.click('a[href="https://volunteer-smart-beta.nu.ac.th/beta-inspectorNew/index.php/Y2568Report05Controller?time_count=1&order=1.4.1&title=นิคม NEXT"]'); // คลิกลิงก์
        ...
        await page.fill('input[name="position_name_reporter"]', 'ผู้รายงาน1.4.1'); // ตำแหน่ง
