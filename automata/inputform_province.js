...
//         //1.2 1.2 งบกองทุน(เฉพาะ สนง.พมจ.)
//         //1 สำนักงานพัฒนาสังคมและความมั่นคงของมนุษย์
//         await page.waitForSelector('input[name="data_fund_budget_only[1][number_of_allocated]"]');
//         await page.fill('input[name="data_fund_budget_only[1][number_of_allocated]"]', '50000'); // กรอกจำนวนงบที่จัดสรร

//         await page.waitForSelector('input[name="data_fund_budget_only[1][number_of_disbursement]"]');
//         await page.fill('input[name="data_fund_budget_only[1][number_of_disbursement]"]', '30000'); // กรอกจำนวนงบที่เบิกจ่าย

//         await page.waitForSelector('textarea[name="data_fund_budget_only[1][detail]"]');
//         await page.fill('textarea[name="data_fund_budget_only[1][detail]"]', 'รายละเอียดการใช้งบประมาณ'); // กรอกรายละเอียด

//         //2 สำนักงานพัฒนาสังคมและความมั่นคงของมนุษย์
//         await page.waitForSelector('input[name="data_fund_budget_only[2][number_of_allocated]"]');
//         await page.fill('input[name="data_fund_budget_only[2][number_of_allocated]"]', '50000'); // กรอกจำนวนงบที่จัดสรร

//         await page.waitForSelector('input[name="data_fund_budget_only[2][number_of_disbursement]"]');
//         await page.fill('input[name="data_fund_budget_only[2][number_of_disbursement]"]', '30000'); // กรอกจำนวนงบที่เบิกจ่าย

//         await page.waitForSelector('textarea[name="data_fund_budget_only[2][detail]"]');
//         await page.fill('textarea[name="data_fund_budget_only[2][detail]"]', 'รายละเอียดการใช้งบประมาณ'); // กรอกรายละเอียด

//         //3 บ้านพักเด็กและครอบครัว
...
//         await page.fill('input[name="data_fund_budget_only[3][number_of_disbursement]"]', '30000'); // กรอกจำนวนงบที่เบิกจ่าย
...
//         //4 ศูนย์คุ้มครองคนไร้ที่พึ่ง
//         await page.waitForSelector('input[name="data_fund_budget_only[4][number_of_allocated]"]');
//         await page.fill('input[name="data_fund_budget_only[4][number_of_allocated]"]', '50000'); // กรอกจำนวนงบที่จัดสรร

//         await page.waitForSelector('input[name="data_fund_budget_only[4][number_of_disbursement]"]');
//         await page.fill('input[name="data_fund_budget_only[4][number_of_disbursement]"]', '30000'); // กรอกจำนวนงบที่เบิกจ่าย

//         await page.waitForSelector('textarea[name="data_fund_budget_only[4][detail]"]');
//         await page.fill('textarea[name="data_fund_budget_only[4][detail]"]', 'รายละเอียดการใช้งบประมาณ'); // กรอกรายละเอียด

//         //5 นิคมสร้างตนเองท้ายเหมือง
//         await page.waitForSelector('input[name="data_fund_budget_only[5][number_of_allocated]"]');
//         await page.fill('input[name="data_fund_budget_only[5][number_of_allocated]"]', '50000'); // กรอกจำนวนงบที่จัดสรร

//         await page.waitForSelector('input[name="data_fund_budget_only[5][number_of_disbursement]"]');
//         await page.fill('input[name="data_fund_budget_only[5][number_of_disbursement]"]', '30000'); // กรอกจำนวนงบที่เบิกจ่าย

//         await page.waitForSelector('textarea[name="data_fund_budget_only[5][detail]"]');
//         await page.fill('textarea[name="data_fund_budget_only[5][detail]"]', 'รายละเอียดการใช้งบประมาณ'); // กรอกรายละเอียด
