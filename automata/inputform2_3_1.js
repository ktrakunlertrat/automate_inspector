...
(async () => {
    ...
    try {
        ...
        // 8️⃣ คลิกเมนู
        await page.waitForSelector('//button[contains(., "2.3.1 การขับเคลื่อนและการดำเนินงานของศูนย์เร่งรัดการจัดสวัสดิภาพประชาชน (ศรส.)")]');
        await page.click('//button[contains(., "2.3.1 การขับเคลื่อนและการดำเนินงานของศูนย์เร่งรัดการจัดสวัสดิภาพประชาชน (ศรส.)")]');

        // 9️⃣ รอให้เมนูย่อยแสดง แล้วคลิก "บันทึกข้อมูลครั้งที่ 1"
        await page.waitForSelector('a[href="https://volunteer-smart-beta.nu.ac.th/beta-inspectorNew/index.php/Y2568Report0207Controller?time_count=1&order=2.3.1&title=การขับเคลื่อนและการดำเนินงานของศูนย์เร่งรัดการจัดสวัสดิภาพประชาชน (ศรส.)"]'); // รอให้ลิงก์โหลด
        await page.click('a[href="https://volunteer-smart-beta.nu.ac.th/beta-inspectorNew/index.php/Y2568Report0207Controller?time_count=1&order=2.3.1&title=การขับเคลื่อนและการดำเนินงานของศูนย์เร่งรัดการจัดสวัสดิภาพประชาชน (ศรส.)"]'); // คลิกลิงก์
        ...
        await page.fill('input[name="position_name_reporter"]', 'ผู้รายงาน2.3.1'); // ตำแหน่ง
