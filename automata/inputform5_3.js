...
(async () => {
    ...
    try {
        ...
        // 8️⃣ คลิกเมนู
        await page.waitForSelector('//button[contains(., "5.3. การขับเคลื่อนโครงการ Flagship กระทรวงการพัฒนาสังคมและความมั่นคงของมนุษย์ประจำปีงบประมาณ พ.ศ. 2568")]');
        await page.click('//button[contains(., "5.3. การขับเคลื่อนโครงการ Flagship กระทรวงการพัฒนาสังคมและความมั่นคงของมนุษย์ประจำปีงบประมาณ พ.ศ. 2568")]');

        // 9️⃣ รอให้เมนูย่อยแสดง แล้วคลิก "บันทึกข้อมูลครั้งที่ 1"
        await page.waitForSelector('a[href="https://volunteer-smart-beta.nu.ac.th/beta-inspectorNew/index.php/Y2568Report05Controller?time_count=1&order=5.3&title=การขับเคลื่อนโครงการ Flagship กระทรวงการพัฒนาสังคมและความมั่นคงของมนุษย์ประจำปีงบประมาณ พ.ศ. 2568"]'); // รอให้ลิงก์โหลด
        await page.click('a[href="https://volunteer-smart-beta.nu.ac.th/beta-inspectorNew/index.php/Y2568Report05Controller?time_count=1&order=5.3&title=การขับเคลื่อนโครงการ Flagship กระทรวงการพัฒนาสังคมและความมั่นคงของมนุษย์ประจำปีงบประมาณ พ.ศ. 2568"]'); // คลิกลิงก์
        ...
        await page.fill('input[name="position_name_reporter"]', 'ผู้รายงาน5.3'); // ตำแหน่ง
