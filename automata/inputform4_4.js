...
(async () => {
    ...
    try {
        ...
        // 8️⃣ คลิกเมนู
        await page.waitForSelector('//button[contains(., "4.4 การใช้ระบบเทคโนโลยีดิจิทัล")]');
        await page.click('//button[contains(., "4.4 การใช้ระบบเทคโนโลยีดิจิทัล")]');

        // 9️⃣ รอให้เมนูย่อยแสดง แล้วคลิก "บันทึกข้อมูลครั้งที่ 1"
        await page.waitForSelector('a[href="https://volunteer-smart-beta.nu.ac.th/beta-inspectorNew/index.php/Y2568Report09Controller?time_count=1&order=4.4&title=การใช้ระบบเทคโนโลยีดิจิทัล"]', { state: 'visible' });
        await page.click('a[href="https://volunteer-smart-beta.nu.ac.th/beta-inspectorNew/index.php/Y2568Report09Controller?time_count=1&order=4.4&title=การใช้ระบบเทคโนโลยีดิจิทัล"]');
        ...
        await page.fill('input[name="position_name_reporter"]', 'ผู้รายงาน4.4'); // ตำแหน่ง
