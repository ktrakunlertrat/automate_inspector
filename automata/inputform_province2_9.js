...
(async () => {
    ...
    try {
        ...
        // 8️⃣ คลิกเมนู "2.9 โครงการยกระดับชุมชนต้นแบบสู่การพัฒนาที่ยั่งยืน (Smart Sustainable Community: SSC)"
        await page.waitForSelector('//button[contains(., "2.9 โครงการยกระดับชุมชนต้นแบบสู่การพัฒนาที่ยั่งยืน (Smart Sustainable Community: SSC)")]');
        await page.click('//button[contains(., "2.9 โครงการยกระดับชุมชนต้นแบบสู่การพัฒนาที่ยั่งยืน (Smart Sustainable Community: SSC)")]');

        // 9️⃣ รอให้เมนูย่อยแสดง แล้วคลิก "บันทึกข้อมูลครั้งที่ 1"
        await page.waitForSelector('a[href="https://volunteer-smart-beta.nu.ac.th/beta-inspectorNew/index.php/Y2568Report0209Controller?time_count=1"]'); // รอให้ลิงก์โหลด
        await page.click('a[href="https://volunteer-smart-beta.nu.ac.th/beta-inspectorNew/index.php/Y2568Report0209Controller?time_count=1"]'); // คลิกลิงก์
        ...
        await page.fill('input[name="position_name_reporter"]', 'ผู้รายงาน2.9'); // ตำแหน่ง
